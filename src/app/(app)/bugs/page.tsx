...
export default async function BugsPage() {
  ...
  return (
    <div className="container py-8">
      <h1 className="text-3xl font-bold font-headline mb-6 text-center md:text-left">Bug Reports</h1>

      <div className="grid grid-cols-1 lg:grid-cols-[1fr_350px] xl:grid-cols-[1fr_400px] gap-8">
